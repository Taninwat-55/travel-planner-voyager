...
export default function HotelDetailsPage() {
  ...
  const originalHotel = location.state?.hotel;
  ...
  const hotel = {
    ...originalHotel,
    availability: originalHotel.availability || [
      {
        type: 'Standardrum - Två sängar',
        rating: 4.5,
        price: '1 450 kr',
        description: 'Avbokningsbart',
      },
      {
        type: 'Deluxe-rum - King size-säng',
        rating: 4.8,
        price: '1 980 kr',
        description: 'Inklusive frukost',
      },
      {
        type: 'Svit med havsutsikt',
        rating: 5.0,
        price: '3 200 kr',
        description: 'Lyxpaket, ej avbokningsbart',
      },
    ],
  };
                    ...
                    <div>
                      ...
                      <p className='mt-1'>
                        {hotel.location_description ||
                          (hotel.address?.toLowerCase().includes('centrum') ||
                          hotel.address?.toLowerCase().includes('center')
                  ...
                  {hotel.hotel_class && (
                    <div className='flex items-center gap-3'>
                      ...
                      <span className='font-medium text-slate-800'>
                        {hotel.hotel_class}{' '}
                        {Array.from(
                          { length: parseInt(hotel.hotel_class) || 0 },
                          () => '★'
                        ).join('')}
                      </span>
                    </div>
              ...
              <div className='bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
                  {hotel.amenities.map((amenity, index) => (
                    <div
                      key={index}
                      className='flex items-center gap-3 bg-white/50 p-4 rounded-xl hover:bg-white/80 transition-colors group'
                    >
                ...
                >
                  ...
                  <div className='p-6'>
                    ...
                    <p className='text-slate-600 font-medium'>
                      {simHotel.rate_per_night?.lowest ||
